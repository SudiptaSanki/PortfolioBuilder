...
- [ ] **swiss-editorial** (`creative-copywriter-swiss-editorial`)
- [ ] **neon-brutalism** (`creative-3d-artist-neon-brutalism`)
- [ ] **kinetic-type** (`creative-motion-designer-kinetic-type`)
- [ ] **comic-book** (`creative-illustrator-comic-book`)
- [ ] **Minimalist Visual Studio** (`vue-minimal`)
- [ ] **Glassmorphic Architect Studio** (`glassmorphic-architect`)
- [ ] **Neon Wireframe 3D Artist** (`neon-wireframe`)
- [ ] **Biophilic Landscape Architect** (`biophilic-sanctuary`)
- [ ] **Vintage Celluloid Film Director** (`vintage-celluloid`)
- [ ] **Concrete Brutalist Architecture** (`concrete-brutalis`)
