...
- [ ] **brutal-structure** (`creative-architect-brutal-structure`)
- [ ] **synth-pulse** (`creative-music-producer-synth-pulse`)
- [ ] **cosmic-lens** (`creative-photographer-cosmic-lens`)
- [ ] **gothic-ink** (`creative-tattoo-artist-gothic-ink`)
- [ ] **bauhaus-grid** (`creative-ui-ux-designer-bauhaus-grid`)
