...
- [ ] **Spray Can Graffiti Artist** (`spray-can`)
- [ ] **Haute Couture Fashion Stylist** (`haute-couture`)
- [ ] **Mars Colony Space Architect** (`mars-colony`)
- [ ] **Fluid Motion Choreographer** (`fluid-motion`)
- [ ] **Clockwork Brass Steampunk** (`clockwork-brass`)
- [ ] **Grand Harmonics Concert Pianist** (`grand-harmonics`)
- [ ] **Analog Groove Vinyl Curator** (`analog-groove`)
- [ ] **Dystopian Haze Concept Artist** (`dystopian-haze`)
- [ ] **Nautical Prestige Superyacht Architect** (`nautical-prestige`)
- [ ] **CRT Cabinet Arcade Restorer** (`crt-cabinet`)
